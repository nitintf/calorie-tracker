import {Button, Flex, Menu, MenuButton, MenuItem, MenuList, Text, Tooltip, useToast,} from '@chakra-ui/react'
...
import {addFoodService, deleteFoodService, updateFoodService,} from '../services/foodService'
...
const FoodCard: React.FC<FoodCardProps> = ({
    ...
    const onUpdate = async () => {
        const {calorie, name, userId} = foodItem
            ...
            <Flex>
                <Flex flexDirection={'column'} maxW='60%' lineHeight={10}>
                    ...
                    <Flex alignItems={'center'} gap={1}>
                        <Text as='p' fontWeight={'700'}>Calories :</Text>
                        <EditableNumber
                    ...
                    {user?.admin && (
                        <Flex alignItems={'center'} gap={1}>
                            ...
                            <EditableNumber
                                placeholder='User id'
                                value={foodItem.userId!}
                                max={undefined}
                                isEdit={isNew}
                                setItem={(e) => setFoodItem((prev) => ({...prev, userId: e}))}
                            />
                        </Flex>
                    )}
                </Flex>
